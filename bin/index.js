...
.usage('Get information about installed packages.\n\nUsage: $0 [options]')
.boolean('dev')
...
.describe('color', 'Display coloured output. Automatically true if output is a TTY unless explicitly turned off.')
